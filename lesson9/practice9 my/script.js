...
function Aspirant(firstName, lastName, group, averageMark, scienceWork) {
  Student.call(firstName, lastName, group, averageMark);
...
let student = new Student('Peter', 'petrov', 2, 9.9)

// console.log(student);
// console.log(student.getScholarship());

let aspirant = new Aspirant('Nick', 'Niksov', 4, 9.8, 'Work 123')
